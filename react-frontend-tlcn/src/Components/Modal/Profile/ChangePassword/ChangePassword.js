    ...
    return (
        <>
            <div className="editcustomer__content">
                {checkError === "Error" ?
                    <>
                        <Error message="Please check the old password again!" setError={setError} />
                    </>
                    :
                    <>
                        ...
                        <div className="editcustomer__content-list">
                            <div className="editcustomer__content-item">
                                ...
                                <div className="editcustomer__input">
                                    <input type="password" className="editcustomer__form" onChange={e => setOldPassword(e.target.value)} />
                                </div>
                            </div>
                            <div className="editcustomer__content-item">
                                <div className="editcustomer__lable">
                                ...
                                <div className="editcustomer__input">
                                    <input type="password" className="editcustomer__form" onChange={e => setPassword(e.target.value)} />
                                </div>
                            </div>
                        </div>
